...
library(tseries)
library(TTR)
source("checks.R", encoding="utf-8")
source("portafoglio.R", encoding="utf-8")
source("getprice.R", encoding="utf-8")
source("tether.R", encoding="utf-8")
source("hma_sign.R", encoding="utf-8")
source("blockize.R", encoding="utf-8")
source("get_risk.R", encoding="utf-8")
source("get_cap.R", encoding="utf-8")
library(xts)
